...
function company(){
    console.log("company" + window.navigator.userAgent.Agent);
}
company();
...
Back();
// ova funkcija vraca dve stranice unazad
...
function question(){
    return prompt("da li imas ljubimca");
}
var answer = question();
function getAnswer(answer){
    if(confirm("we will submin this answer now ! " + answer)){
        alert("succeess");
    }
}
getAnswer(answer);
