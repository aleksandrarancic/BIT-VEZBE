//book
class Book{
    construktor(title,author,copyrightDate,ISBN,numPages){
        this.title = title;
        this.author = author;
        ...
        this.discardted = false;

    }
    discardtedBook(){
        this.discardted = true;
    }
...
class Novel extends Book{
    ...
    updateCheckOut(numberOfTimesCheckeOut){
        this.numTimesCheckeOut += numberOfTimesCheckeOut;
    }

}
var novel = new Novel("Na Drini Cuprija", "Ivo Andric", 1945, "987445685456", 366);
var manuel = new Manuel("Python Programming for Beginners", "John Smith", 2016, "9781234567890", 300);
novel.updateCheckOut(5);
manuel.checkDisposal();
